...
#import "WebRefreshView.h"
#import "SRRefreshView.h"

@interface WebRefreshView () <SRRefreshDelegate>
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [self.scrollView addSubview:_srHeadView];
...
{
    if ([self.scrollView.subviews containsObject:_srHeadView]) {
...
{
    if ([self.srdelegate respondsToSelector:@selector(srWebViewLoadDataWithRefresh)]) {
        [self.srdelegate srWebViewLoadDataWithRefresh];
    } else {
        NSLog(@"下拉刷新代理没有响应");
    }
