...
#import "NetWork_queryFollowed.h" //我的关注
@interface MyAttentionViewController ()<UITextFieldDelegate>{
    BOOL _canedit;
}
...
-(void)initRequest{
    ...
    NetWork_queryFollowed *request = [[NetWork_queryFollowed alloc] init];
